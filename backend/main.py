...
@api_router.post("/incidents", response_model=IncidentResponse, status_code=status.HTTP_201_CREATED, tags=["Incidents"])
...
@api_router.get("/incidents", response_model=List[IncidentResponse], tags=["Incidents"])
...
@api_router.get("/incidents/filters", tags=["Incidents"])
...
@api_router.get("/incidents/filters/dynamic", tags=["Incidents"])
...
@api_router.get("/incidents/{incident_id}", response_model=IncidentResponse, tags=["Incidents"])
...
@api_router.put("/incidents/{incident_id}", response_model=IncidentResponse, tags=["Incidents"])
...
@api_router.delete("/incidents/{incident_id}", status_code=status.HTTP_204_NO_CONTENT, tags=["Incidents"])
...
@api_router.post("/incidents/search", response_model=List[IncidentResponse], tags=["Search"])
...
@api_router.get("/statistics", response_model=StatisticsResponse, tags=["Analytics"])
...
@api_router.post("/incidents/bulk-upload", response_model=BulkUploadResponse, tags=["Bulk Operations"])
...
@api_router.post("/incidents/batch", response_model=BulkUploadResponse, tags=["Bulk Operations"])
...
@api_router.post("/excel/parse", tags=["Excel Upload"])
...
@api_router.post("/excel/enrich", tags=["Excel Upload"])
...
# Assistant Endpoints
@api_router.post("/assistant/chat", tags=["Assistant"])
