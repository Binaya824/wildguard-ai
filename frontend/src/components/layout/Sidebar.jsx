  ...
  return (
    <aside className={cn(
      ...
      <div className={cn("flex items-center gap-3 p-6", isCollapsed && "justify-center px-2")}>
        <div className="w-10 h-10 rounded-full object-fill bg-emerald-50 bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center shadow-lg shadow-emerald-500/20">
          <img className='w-full h-full rounded-full' src="/logo.jpg" alt="WildGuard Logo" />
        </div>
        {!isCollapsed && (
          <div className="overflow-hidden whitespace-nowrap animate-in fade-in duration-300">
            <h1 className="font-bold text-lg tracking-tight text-slate-900">WildGuard</h1>
