...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchFilterOptions = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/incidents/filters`);
        setFilterOptions({
    ...
    const fetchStats = async () => {
      try {
        ...
        const response = await axios.get(`${import.meta.env.VITE_API_URL}/statistics?${params.toString()}`);
