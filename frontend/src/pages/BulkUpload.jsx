...
const BulkUpload = () => {
  ...
  const handleFileDrop = async (e) => {
    ...
    if (droppedFile) {
      ...
      try {
        ...
        const response = await axios.post(`${import.meta.env.VITE_API_URL}/excel/parse`, formData, {
  ...
  const handleCommit = async () => {
    ...
    try {
      ...
      await axios.post(`${import.meta.env.VITE_API_URL}/incidents/batch`, parsedIncidents);
      setStep('success');
    } catch (err) {
      console.error(err);
