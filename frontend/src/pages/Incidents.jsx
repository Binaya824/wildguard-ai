...
const Incidents = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const res = await axios.get(`${import.meta.env.VITE_API_URL}/incidents/filters`);
  ...
  const fetchIncidents = async (overridePage = page) => {
    ...
    try {
      ...
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/incidents?${params.toString()}`);
             ...
             <button 
              onClick={async () => {
                if(window.confirm('Are you sure you want to delete this incident?')) {
                  try {
                    await axios.delete(`${import.meta.env.VITE_API_URL}/incidents/${selectedIncident._id}`);
                    fetchIncidents();
